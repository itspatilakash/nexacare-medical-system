...
import { sendOtp, verifyOtp, registerUser, loginUser, } from '../services/auth.service';
import { registrationSchema, otpVerificationSchema, loginSchema, } from '../../shared/schema';
const router = Router();
