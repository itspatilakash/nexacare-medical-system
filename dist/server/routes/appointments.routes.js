...
router.get('/patient/:patientId', authenticateToken, authorizeRoles('patient'), async (req, res) => {
    try {
...
router.get('/doctor/:doctorId', authenticateToken, authorizeRoles('doctor'), async (req, res) => {
    try {
