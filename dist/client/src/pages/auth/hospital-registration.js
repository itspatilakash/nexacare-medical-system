          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <Input {...register("name")} placeholder="Enter hospital name" className="w-full"/>
              ...
              <div>
                ...
                <Input {...register("licenseNumber")} placeholder="Enter license number" className="w-full"/>
              ...
              <div>
                ...
                <Input {...register("contactEmail")} type="email" placeholder="contact@hospital.com" className="w-full"/>
              ...
              <div>
                ...
                <Input {...register("website")} placeholder="www.hospital.com" className="w-full"/>
              </div>
              ...
              <div>
                ...
                <Input {...register("establishedYear")} type="number" placeholder="1990" min="1800" max={new Date().getFullYear()} className="w-full"/>
              ...
              <div>
                ...
                <Input {...register("totalBeds")} type="number" placeholder="100" min="1" className="w-full"/>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {departments.map((department) => (<div key={department} className="flex items-center space-x-2">
                    <Checkbox id={`dept-${department}`} checked={selectedDepartments.includes(department)} onCheckedChange={(checked) => handleDepartmentChange(department, checked)}/>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {services.map((service) => (<div key={service} className="flex items-center space-x-2">
                    <Checkbox id={`service-${service}`} checked={selectedServices.includes(service)} onCheckedChange={(checked) => handleServiceChange(service, checked)}/>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox id="emergency" {...register("emergencyServices")}/>
