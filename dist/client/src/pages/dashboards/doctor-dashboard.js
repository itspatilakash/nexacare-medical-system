...
export default function DoctorDashboard() {
    ...
    return (<DashboardLayout title="Dr. Sarah Johnson" subtitle="Cardiology" icon={<UserRound className="w-6 h-6 text-white"/>} navigationItems={navigationItems} headerActions={headerActions}>
      {/* Quick Stats */}
      ...
      <Card className="mb-6">
        ...
        <CardContent className="p-6">
          {appointmentsLoading ? (<div className="space-y-4">
            ...
            </div>) : todayAppointments && todayAppointments.length > 0 ? (<div className="space-y-4">
              {todayAppointments.map((appointment) => (<div key={appointment.id} className="flex items-center justify-between py-4 border-b border-gray-100 last:border-b-0">
                  <div className="flex items-center">
