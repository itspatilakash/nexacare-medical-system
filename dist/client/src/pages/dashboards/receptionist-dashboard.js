...
export default function ReceptionistDashboard() {
    ...
    const headerActions = (<div className="flex space-x-2">
    ...
    return (<DashboardLayout title="Reception Desk" subtitle="City General Hospital" icon={<Users className="w-6 h-6 text-white"/>} navigationItems={navigationItems} headerActions={headerActions}>
      {/* Reception Stats */}
      ...
      <Card className="mb-6">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              ...
              <Button size="sm" className="medical-blue hover:bg-blue-700" onClick={() => setIsBookingModalOpen(true)}>
                Add Walk-in
              </Button>
            </div>
          </div>
        ...
        <CardContent className="p-6">
          {appointmentsLoading ? (<div className="space-y-4">
            ...
            </div>) : todayAppointments.length > 0 ? (<div className="space-y-4">
              {todayAppointments
                .sort((a, b) => a.appointmentTime.localeCompare(b.appointmentTime))
                .map((appointment) => (<div key={appointment.id} className="flex items-center justify-between py-4 border-b border-gray-100 last:border-b-0">
                    <div className="flex items-center">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex space-x-2">
                        {appointment.status === 'scheduled' && (<Button size="sm" className="medical-green hover:bg-green-600">
                            Check In
                          </Button>)}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Button variant="outline" className="h-20 flex flex-col items-center justify-center space-y-2" onClick={() => setIsBookingModalOpen(true)}>
      ...
      <AppointmentBookingModal isOpen={isBookingModalOpen} onClose={() => setIsBookingModalOpen(false)} isWalkIn={true}/>
    </DashboardLayout>);
}
