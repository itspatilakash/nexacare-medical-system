...
import { X, MapPin, Stethoscope, IndianRupee, Clock, Calendar, User, AlertCircle } from "lucide-react";
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3 max-h-96 overflow-y-auto">
              {hospitalsLoading ? (
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 mt-2">
                            ...
                            {hospital.emergencyServices && (
                              <Badge variant="outline" className="text-red-600">24x7 Emergency</Badge>
                            )}
                          </div>
                        </div>
                      </div>
                ...
                <div className="text-center py-4 text-gray-500">No hospitals available</div>
              )}
            </div>
          </div>
        );
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 mt-2">
                            ...
                            <Badge 
                              variant={doctor.status === 'in' ? 'default' : 'outline'}
                              className={doctor.status === 'in' ? 'bg-green-100 text-green-800' : ''}
                            >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select 
                ...
                onValueChange={(value) => setAppointmentDetails(prev => ({...prev, priority: value}))}
              >
                <SelectTrigger>
          ...
          <div className="flex space-x-2">
            {step < 4 && (
              <Button
                type="button"
                onClick={() => {
                  if (step === 1 && selectedHospital) setStep(2);
                  else if (step === 2 && selectedDoctor) setStep(3);
                  else if (step === 3 && selectedDate && selectedSlot) setStep(4);
                }}
                disabled={
            ...
            {step === 4 && (
              <Button
                ...
                disabled={createAppointmentMutation.isPending || !appointmentDetails.reason}
