              ...
              {medications.map((medication, index) => (
                <div key={index} className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg">
                  <Input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-medical-blue focus:border-transparent"
                  />
                  <Input
                    type="text"
                    placeholder="Dosage"
                    ...
                    className="w-24 px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-medical-blue focus:border-transparent"
                  />
                  <Input
                    type="text"
                    ...
                    className="w-32 px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-medical-blue focus:border-transparent"
                  />
                  <Input
                    type="text"
